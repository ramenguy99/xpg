...
_cube_indices = np.array([ 1, 5, 2, 2, 5, 6, 5, 4, 6, 6, 4, 7, 3, 2, 7, 7, 2, 6, 0, 1, 3, 3, 1, 2, 4, 0, 7, 7, 0, 3, 4, 5, 0, 0, 5, 1], np.uint32)

def create_cube(position: vec3 = (0, 0, 0), half_extents: vec3 = (1, 1, 1)):
    return _cube_positions * np.asarray(half_extents, np.float32) + np.asarray(position, np.float32), _cube_indices.copy()
