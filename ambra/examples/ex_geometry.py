...
cube = Mesh(cube_v, cube_f, cube_n, cull_mode=CullMode.BACK, translation=(-2.5, 0, 0))
...
cone = Mesh(cone_v, cone_f, cone_n, cull_mode=CullMode.BACK, translation=(2.5, 0, 0))
...
capped_cone = Mesh(capped_cone_v, capped_cone_f, capped_cone_n, cull_mode=CullMode.BACK, translation=(2.5, -2.5, 0))
...
disk = Mesh(disk_v, disk_f, disk_n, cull_mode=CullMode.BACK, translation=(0, 2.5, 0))
...
cylinder = Mesh(cylinder_v, cylinder_f, cylinder_n, cull_mode=CullMode.BACK, translation=(0, -2.5, 0))
...
cap_cylinder = Mesh(
    cap_cylinder_v, cap_cylinder_f, cap_cylinder_n, cull_mode=CullMode.BACK, translation=(-2.5, -2.5, 0)
)
...
sphere = Mesh(sphere_v, sphere_f, sphere_n, cull_mode=CullMode.BACK, translation=(-2.5, 2.5, 0))
...
arrow = Mesh(arrow_v, arrow_f, arrow_n, cull_mode=CullMode.BACK, translation=(2.5, 2.5, 0))
